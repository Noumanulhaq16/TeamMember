        ...
        <HeaderStyle>
          ...
          {smUp && (
            <Typography variant="body2" sx={{ mt: { md: -2 } }}>
              ...
              <Link variant="subtitle2" component={RouterLink} to={PATH_AGENT_AUTH.login}>
                Login
              </Link>
            </Typography>
          )}
        ...
        {/* {mdUp && (
          <SectionStyle>
            <Typography variant="h3" sx={{ px: 5, mt: 10, mb: 5 }}>
              Manage the job more effectively with Teams
            </Typography>
            <Image
              alt="register"
              src={Team}
          ...
          <ContentStyle>
            <Stack direction="row" alignItems="center" sx={{ mb: 5 }}>
              <Box sx={{ flexGrow: 1 }}>
                <Typography variant="h4" gutterBottom>
                  Sign in to Teams :    Agent Register
                </Typography>
            ...
            {!smUp && (
              <Typography variant="body2" sx={{ mt: 3, textAlign: 'center' }}>
                Already have an account?{' '}
                <Link variant="subtitle2" to={PATH_AGENT_AUTH.login} component={RouterLink}>
                  Login
                </Link>
              </Typography>
            )}
